...
export class AppGlobals {
  ...
  readonly baseReportUrl: string = 'http://lmsreports.autopay-mcs.com/default.aspx?';
  readonly baseReportEmailUrl: string = 'http://lmsreports.autopay-mcs.com/default2.aspx?';
