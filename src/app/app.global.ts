...
export class AppGlobals {
 ...
 readonly baseLandingAppUrl: string = "http://49.50.77.201/qualityhouse/";
  ...
  /* Development Server */
  readonly baseAPIFileUrl: string = "http://49.50.77.201/lmsapi/";
  readonly baseAPIUrl: string = "http://49.50.77.201/lmsapi/api/";
  readonly baseAPIRootUrl: string = "http://49.50.77.201/lmsapi/api/";
